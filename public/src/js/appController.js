/**
 * Copyright (c) 2014, 2017, Oracle and/or its affiliates. The Universal
 ...
 */
define(
		[ 'ojs/ojcore', 'knockout', 'ojs/ojrouter', 'ojs/ojknockout',
		...
		function(oj, ko) {
			function ControllerViewModel() {
				...
				var smQuery = oj.ResponsiveUtils
						.getFrameworkQuery(oj.ResponsiveUtils.FRAMEWORK_QUERY_KEY.SM_ONLY);
				self.smScreen = oj.ResponsiveKnockoutUtils
						.createMediaQueryObservable(smQuery);
